...
bash ./scripts/save_activation.sh
...
bash ./scripts/save_activation.sh
# compute the cka-similarity
python compute_cka.py --base_model init-llama-seed-1000 --base_layers -1 --test_model llama-160M-openwebtext-seed-1000 --test_layers -1 
python compute_cka.py --base_model llama-160M-openwebtext-seed-1000 --base_layers -1 --test_model llama-160M-openwebtext-seed-123 --test_layers -1 

python compute_cka.py --base_model llama-160M-openwebtext-seed-1000 --base_layers -1 --test_model llama-160M-finetune-TinyStoriesV2_cleaned-seed-1000 --test_layers -1 
python compute_cka.py --base_model llama-160M-openwebtext-seed-1000 --base_layers -1 --test_model llama-160M-finetune-TinyStoriesV2_cleaned-seed-123 --test_layers -1 

python compute_cka.py --base_model llama-160M-openwebtext-seed-1000 --base_layers -1 --test_model llama-160M-fullset-finetune-code_stack-seed-1000 --test_layers -1 
python compute_cka.py --base_model llama-160M-openwebtext-seed-1000 --base_layers -1 --test_model llama-160M-fullset-finetune-code_stack-seed-123 --test_layers -1 
# plot the cka-heatmap
plot.ipynb
```
