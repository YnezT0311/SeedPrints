...
models=(
    ...
    # 'init-llama-seed-2000'
    # 'init-llama-seed-42'
    # 'llama-160M-openwebtext-seed-2000'
    # 'llama-160M-openwebtext-seed-42'
    # 'llama-160M-finetune-BabyLM-seed-123'
    # 'llama-160M-finetune-BabyLM-seed-1000'
    # 'llama-160M-finetune-TinyStoriesV2_cleaned-seed-123'
    # 'llama-160M-finetune-TinyStoriesV2_cleaned-seed-1000'
    # 'llama-160M-fullset-finetune-code_stack-seed-1000'
    # 'llama-160M-fullset-finetune-code_stack-seed-123'
)
