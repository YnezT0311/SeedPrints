...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_layers", nargs='+', type=int, default=[12], help="Layers to load activations; can also set 24/32/40/80 to load all layers' activations according to the model size")
    parser.add_argument("--test_model", default="EleutherAI/llemma_7b")
    parser.add_argument("--test_layers", nargs='+', type=int, default=[12], help="Layers to load activations; can also set 24/32/40/80 to load all layers' activations according to the model size")
    ...
    if args.base_layers[0] in [12,24,32,40,80]:
