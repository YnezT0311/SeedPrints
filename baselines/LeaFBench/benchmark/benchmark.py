        ...
        for base_name in base_model_names:
            ...
            for test_name in test_model_names:
                ...
                if base_model.type == 'pretrained' and test_model.pretrained_model == base_name:
                    is_positive = True
                elif base_model.type == 'instruct':
                    if test_model.instruct_model == base_name:
                        is_positive = True
                    elif test_model.type == 'pretrained' and base_model.pretrained_model == test_model.model_name:
                        is_positive = True
