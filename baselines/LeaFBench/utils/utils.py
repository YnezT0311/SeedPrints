...
def load_args():
    ...
    parser.add_argument('--fingerprint_config', type=str, default='config/seed.yaml', help='Path to the fingerprint configuration file')
...
def setup_environment(args):
    ...
    if num_gpus > 1:
        ...
        # Initialize accelerator with explicit multi-GPU config
